...
class MapUtils {
  ...
  /**
   * Attempts to retrieve the specified value as an integer. It can recognize the value either as a
   * Number object or a string to be parsed.
   *
   * @param map a map containing the value
   * @param key the map key at which the value is found
  ...
  /**
   * Returns the specified map value as an array of strings. If it is a scalar, it will be returned
   * as an array containing only the found value.
   *
   * @param map a map containing the value
   * @param key the map key at which the value is found
   * @return the string representation of the value
  ...
  /**
   * Attempts to retrieve the specified value as a boolean. It can recognize the value either as a
   * Boolean object or a string.
   *
   * @param map a map containing the value
   * @param key the map key at which the value is found
   ...
   */
  static IllegalArgumentException createBadTypeException(
      String key, Object value, String expectedType) {
    return new IllegalArgumentException(
        String.format(ILLEGAL_VALUE_FORMAT, key, value, expectedType));
  }
}
